...
void Jack::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/jack/jack_f.png";
	m_strHeroSmallHeadFileName = "LFR/jack/jack_s.png";

	m_strFacetoLeftStaticFileName = "LFR/jack/jack_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/jack/jack_0.png";

	m_strFacetoLeftMoveFileName = "LFR/jack/jack_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/jack/jack_0.png";

	m_strFacetoLeftAttackFileName = "LFR/jack/jack_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/jack/jack_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/jack/jack_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/jack/jack_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/jack/jack_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/jack/jack_0.png";
}

void Jack::SetFacetoLeftStaticAnimation()
{
...
void Jack::SetFacetoRightStaticAnimation()
{
...
void Jack::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Jack::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Jack::SetFacetoLeftAttackAnimation()
{
...
void Jack::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void Jack::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
	m_State = MAGICATTACK_STATE;
	DEFINE_MOVE_MAGIC(seq,"LFR/jack/jack_b_mirror.png",directon_left,GlobalValue::magic_distance,0,2,3,-1,false,82,83,0.1);

	
}

void Jack::SetFacetoRightMagicAttackAnimation(cocos2d::Sequence*& seq)
{
	m_State = MAGICATTACK_STATE;
	DEFINE_MOVE_MAGIC(seq,"LFR/jack/jack_b.png",directon_right,GlobalValue::magic_distance,0,2,3,-1,false,82,83,0.1);
}

void Jack::SetFacetoLeftParryAnimation()
{
...
void Jack::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void Jack::SetFacetoLeftInjuredAnimation()
{
}

void Jack::SetFacetoRightInjuredAnimation()
{
}

void Jack::SetFacetoLeftBeHitAnimation()
{
}

void Jack::SetFacetoRightBeHitAnimation()
{
}

void Jack::SetFacetoLeftGetUpAnimation()
{
}

void Jack::SetFacetoRightGetUpAnimation()
{
}

void Jack::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void Jack::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
