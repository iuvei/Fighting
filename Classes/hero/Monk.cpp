...
void Monk::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/monk/monk_f.png";
	m_strHeroSmallHeadFileName = "LFR/monk/monk_s.png";

	m_strFacetoLeftStaticFileName = "LFR/monk/monk_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/monk/monk_0.png";

	m_strFacetoLeftMoveFileName = "LFR/monk/monk_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/monk/monk_0.png";

	m_strFacetoLeftAttackFileName = "LFR/monk/monk_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/monk/monk_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/monk/monk_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/monk/monk_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/monk/monk_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/monk/monk_0.png";
}

void Monk::SetFacetoLeftStaticAnimation()
{
...
void Monk::SetFacetoRightStaticAnimation()
{
...
void Monk::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Monk::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Monk::SetFacetoLeftAttackAnimation()
{
...
void Monk::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void Monk::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
...
void Monk::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void Monk::SetFacetoLeftInjuredAnimation()
{
}

void Monk::SetFacetoRightInjuredAnimation()
{
}

void Monk::SetFacetoLeftBeHitAnimation()
{
}

void Monk::SetFacetoRightBeHitAnimation()
{
}

void Monk::SetFacetoLeftGetUpAnimation()
{
}

void Monk::SetFacetoRightGetUpAnimation()
{
}

void Monk::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void Monk::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
