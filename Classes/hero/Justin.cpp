...
void Justin::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/justin/justin_f.png";
	m_strHeroSmallHeadFileName = "LFR/justin/justin_s.png";

	m_strFacetoLeftStaticFileName = "LFR/justin/justin_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/justin/justin_0.png";

	m_strFacetoLeftMoveFileName = "LFR/justin/justin_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/justin/justin_0.png";

	m_strFacetoLeftAttackFileName = "LFR/justin/justin_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/justin/justin_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/justin/justin_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/justin/justin_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/justin/justin_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/justin/justin_0.png";
}

void Justin::SetFacetoLeftStaticAnimation()
{
...
void Justin::SetFacetoRightStaticAnimation()
{
...
void Justin::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Justin::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Justin::SetFacetoLeftAttackAnimation()
{
...
void Justin::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void Justin::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
...
void Justin::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void Justin::SetFacetoLeftInjuredAnimation()
{
}

void Justin::SetFacetoRightInjuredAnimation()
{
}

void Justin::SetFacetoLeftBeHitAnimation()
{
}

void Justin::SetFacetoRightBeHitAnimation()
{
}

void Justin::SetFacetoLeftGetUpAnimation()
{
}

void Justin::SetFacetoRightGetUpAnimation()
{
}

void Justin::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void Justin::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
