...
void Julian::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/julian/julian_f.png";
	m_strHeroSmallHeadFileName = "LFR/julian/julian_s.png";

	m_strFacetoLeftStaticFileName = "LFR/julian/julian_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/julian/julian_0.png";

	m_strFacetoLeftMoveFileName = "LFR/julian/julian_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/julian/julian_0.png";

	m_strFacetoLeftAttackFileName = "LFR/julian/julian_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/julian/julian_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/julian/julian_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/julian/julian_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/julian/julian_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/julian/julian_0.png";
}

void Julian::SetFacetoLeftStaticAnimation()
{
...
void Julian::SetFacetoRightStaticAnimation()
{
...
void Julian::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Julian::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Julian::SetFacetoLeftAttackAnimation()
{
...
void Julian::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void Julian::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
...
void Julian::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void Julian::SetFacetoLeftInjuredAnimation()
{
}

void Julian::SetFacetoRightInjuredAnimation()
{
}

void Julian::SetFacetoLeftBeHitAnimation()
{
}

void Julian::SetFacetoRightBeHitAnimation()
{
}

void Julian::SetFacetoLeftGetUpAnimation()
{
}

void Julian::SetFacetoRightGetUpAnimation()
{
}

void Julian::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void Julian::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
