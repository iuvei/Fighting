...
void Hunter::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/hunter/hunter_f.png";
	m_strHeroSmallHeadFileName = "LFR/hunter/hunter_s.png";

	m_strFacetoLeftStaticFileName = "LFR/hunter/hunter_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/hunter/hunter_0.png";

	m_strFacetoLeftMoveFileName = "LFR/hunter/hunter_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/hunter/hunter_0.png";

	m_strFacetoLeftAttackFileName = "LFR/hunter/hunter_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/hunter/hunter_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/hunter/hunter_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/hunter/hunter_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/hunter/hunter_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/hunter/hunter_0.png";
}

void Hunter::SetFacetoLeftStaticAnimation()
{
...
void Hunter::SetFacetoRightStaticAnimation()
{
...
void Hunter::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Hunter::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Hunter::SetFacetoLeftAttackAnimation()
{
...
void Hunter::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void Hunter::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
...
void Hunter::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void Hunter::SetFacetoLeftInjuredAnimation()
{
}

void Hunter::SetFacetoRightInjuredAnimation()
{
}

void Hunter::SetFacetoLeftBeHitAnimation()
{
}

void Hunter::SetFacetoRightBeHitAnimation()
{
}

void Hunter::SetFacetoLeftGetUpAnimation()
{
}

void Hunter::SetFacetoRightGetUpAnimation()
{
}

void Hunter::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void Hunter::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
