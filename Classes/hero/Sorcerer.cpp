...
void Sorcerer::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/sorcerer/sorcerer_f.png";
	m_strHeroSmallHeadFileName = "LFR/sorcerer/sorcerer_s.png";

	m_strFacetoLeftStaticFileName = "LFR/sorcerer/sorcerer_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/sorcerer/sorcerer_0.png";

	m_strFacetoLeftMoveFileName = "LFR/sorcerer/sorcerer_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/sorcerer/sorcerer_0.png";

	m_strFacetoLeftAttackFileName = "LFR/sorcerer/sorcerer_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/sorcerer/sorcerer_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/sorcerer/sorcerer_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/sorcerer/sorcerer_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/sorcerer/sorcerer_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/sorcerer/sorcerer_0.png";
}

void Sorcerer::SetFacetoLeftStaticAnimation()
{
...
void Sorcerer::SetFacetoRightStaticAnimation()
{
...
void Sorcerer::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Sorcerer::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Sorcerer::SetFacetoLeftAttackAnimation()
{
...
void Sorcerer::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void Sorcerer::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
...
void Sorcerer::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void Sorcerer::SetFacetoLeftInjuredAnimation()
{
}

void Sorcerer::SetFacetoRightInjuredAnimation()
{
}

void Sorcerer::SetFacetoLeftBeHitAnimation()
{
}

void Sorcerer::SetFacetoRightBeHitAnimation()
{
}

void Sorcerer::SetFacetoLeftGetUpAnimation()
{
}

void Sorcerer::SetFacetoRightGetUpAnimation()
{
}

void Sorcerer::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void Sorcerer::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
