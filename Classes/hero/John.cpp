...
void John::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/john/john_f.png";
	m_strHeroSmallHeadFileName = "LFR/john/john_s.png";

	m_strFacetoLeftStaticFileName = "LFR/john/john_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/john/john_0.png";

	m_strFacetoLeftMoveFileName = "LFR/john/john_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/john/john_0.png";

	m_strFacetoLeftAttackFileName = "LFR/john/john_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/john/john_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/john/john_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/john/john_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/john/john_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/john/john_0.png";
}

void John::SetFacetoLeftStaticAnimation()
{
...
void John::SetFacetoRightStaticAnimation()
{
...
void John::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void John::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void John::SetFacetoLeftAttackAnimation()
{
...
void John::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void John::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
...
void John::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void John::SetFacetoLeftInjuredAnimation()
{
}

void John::SetFacetoRightInjuredAnimation()
{
}

void John::SetFacetoLeftBeHitAnimation()
{
}

void John::SetFacetoRightBeHitAnimation()
{
}

void John::SetFacetoLeftGetUpAnimation()
{
}

void John::SetFacetoRightGetUpAnimation()
{
}

void John::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void John::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
