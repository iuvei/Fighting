...
void Woody::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/woody/woody_f.png";
	m_strHeroSmallHeadFileName = "LFR/woody/woody_s.png";

	m_strFacetoLeftStaticFileName = "LFR/woody/woody_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/woody/woody_0.png";

	m_strFacetoLeftMoveFileName = "LFR/woody/woody_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/woody/woody_0.png";

	m_strFacetoLeftAttackFileName = "LFR/woody/woody_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/woody/woody_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/woody/woody_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/woody/woody_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/woody/woody_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/woody/woody_0.png";
}

void Woody::SetFacetoLeftStaticAnimation()
{
...
void Woody::SetFacetoRightStaticAnimation()
{
...
void Woody::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Woody::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Woody::SetFacetoLeftAttackAnimation()
{
...
void Woody::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void Woody::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
...
void Woody::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void Woody::SetFacetoLeftInjuredAnimation()
{
}

void Woody::SetFacetoRightInjuredAnimation()
{
}

void Woody::SetFacetoLeftBeHitAnimation()
{
}

void Woody::SetFacetoRightBeHitAnimation()
{
}

void Woody::SetFacetoLeftGetUpAnimation()
{
}

void Woody::SetFacetoRightGetUpAnimation()
{
}

void Woody::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void Woody::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
