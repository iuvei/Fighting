...
void Bat::SetAllAnimationFile()
{
	m_strHeroBigHeadFileName = "LFR/bat/bat_f.png";
	m_strHeroSmallHeadFileName = "LFR/bat/bat_s.png";

	m_strFacetoLeftStaticFileName = "LFR/bat/bat_0_mirror.png";
	m_strFacetoRightStaticFileName = "LFR/bat/bat_0.png";

	m_strFacetoLeftMoveFileName = "LFR/bat/bat_0_mirror.png";
	m_strFacetoRightMoveFileName = "LFR/bat/bat_0.png";

	m_strFacetoLeftAttackFileName = "LFR/bat/bat_0_mirror.png";
	m_strFacetoRightAttackFileName = "LFR/bat/bat_0.png";

	m_strFacetoLeftMagicAttackFileName;
	m_strFacetoRightMagicAttackFileName;

	m_strFacetoLeftParryFileName = "LFR/bat/bat_0_mirror.png";
	m_strFacetoRightParryFileName = "LFR/bat/bat_0.png";
	...
	m_strFacetoLeftDieFileName = "LFR/bat/bat_0_mirror.png";
	m_strFacetoRightDieFileName = "LFR/bat/bat_0.png";
}

void Bat::SetFacetoLeftStaticAnimation()
{
...
void Bat::SetFacetoRightStaticAnimation()
{
...
void Bat::SetFacetoLeftMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Bat::SetFacetoRightMoveAnimation()
{
	m_State = MOVE_STATE;
...
void Bat::SetFacetoLeftAttackAnimation()
{
...
void Bat::SetFacetoRightAttackAnimation()
{
	m_State = ATTACK_STATE;
...
void Bat::SetFacetoLeftMagicAttackAnimation(cocos2d::Sequence*& seq)
{
	m_State = MAGICATTACK_STATE;
	DEFINE_MOVE_MAGIC(seq,"LFR/bat/bat_chase_mirror.png",directon_left,GlobalValue::magic_distance,1,2,3,-1,false,81,81,0.1);

	
}

void Bat::SetFacetoRightMagicAttackAnimation(cocos2d::Sequence*& seq)
{
	m_State = MAGICATTACK_STATE;
	DEFINE_MOVE_MAGIC(seq,"LFR/bat/bat_chase.png",directon_right,GlobalValue::magic_distance,1,2,3,-1,false,81,81,0.1);
}

void Bat::SetFacetoLeftParryAnimation()
{
...
void Bat::SetFacetoRightParryAnimation()
{
	/*cocos2d::Sequence *sequence = NULL;
	cocos2d::Spawn *spawn = NULL;
...
void Bat::SetFacetoLeftInjuredAnimation()
{
}

void Bat::SetFacetoRightInjuredAnimation()
{
}

void Bat::SetFacetoLeftBeHitAnimation()
{
}

void Bat::SetFacetoRightBeHitAnimation()
{
}

void Bat::SetFacetoLeftGetUpAnimation()
{
}

void Bat::SetFacetoRightGetUpAnimation()
{
}

void Bat::SetFacetoLeftDieAnimation()
{
	m_State = DEATH_STATE;
...
void Bat::SetFacetoRightDieAnimation()
{
	m_State = DEATH_STATE;
