#include "GameRoundListView.h"
#include "HeroManager.h"

bool GameRoundListView::InitView(Point ori,Size itemSize,int count,bool bVERTICAL,bool bScale,vector<GameRound>& gamrround)
{
	if ( !Layer::init() )
	{
		return false;
	...
	m_nItemCount = m_GameRoundList.size();
...
//触摸到某个cell的事件
void GameRoundListView::tableCellTouched(cocos2d::extension::TableView* table, cocos2d::extension::TableViewCell* cell)
{
	...
	sprite->runAction(m_pSequence);

}

//定制每个cell的size
cocos2d::CCSize GameRoundListView::tableCellSizeForIndex(cocos2d::extension::TableView *table, ssize_t idx)
{
	return m_ItemSize;
}

//定制每个cell的内容
cocos2d::extension::TableViewCell* GameRoundListView::tableCellAtIndex(cocos2d::extension::TableView *table, ssize_t idx)
{
...
ssize_t GameRoundListView::numberOfCellsInTableView(cocos2d::extension::TableView *table)
{
	return m_nItemCount;
}

//设置单元格高亮的状态
void GameRoundListView::tableCellHighlight(TableView* table, TableViewCell* cell)
{
}

//设置单元格非高亮的状态
void GameRoundListView::tableCellUnhighlight(TableView* table, TableViewCell* cell)
{
